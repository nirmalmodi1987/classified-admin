...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\htdocs\laravelprojects\classified-ads-admin\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\xampp\\htdocs\\laravelprojects\\classified-ads-admin\\public\\storage','logging.default','logging.deprecations.channel',
...
'debugbar.route_domain','debugbar.theme','debugbar.debug_backtrace_limit','media-library.disk_name','media-library.max_file_size',
...
'debugbar.queries.explain','adminlte.darkmode.toggle','storage.local',);
        registerArgumentsSet('views', 
'welcome','adminlte::auth.auth-page','adminlte::auth.login','adminlte::auth.passwords.confirm','adminlte::auth.passwords.email',
...
'validation.url','validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','adminlte.0',
'iframe.0','menu.0','adminlte::adminlte.full_name','adminlte::adminlte.email','adminlte::adminlte.password',
'adminlte::adminlte.retype_password','adminlte::adminlte.remember_me','adminlte::adminlte.register','adminlte::adminlte.register_a_new_membership','adminlte::adminlte.i_forgot_my_password',
'adminlte::adminlte.i_already_have_a_membership','adminlte::adminlte.sign_in','adminlte::adminlte.log_out','adminlte::adminlte.toggle_navigation','adminlte::adminlte.login_message',
'adminlte::adminlte.register_message','adminlte::adminlte.password_reset_message','adminlte::adminlte.reset_password','adminlte::adminlte.send_password_reset_link','adminlte::adminlte.verify_message',
'adminlte::adminlte.verify_email_sent','adminlte::adminlte.verify_check_your_email','adminlte::adminlte.verify_if_not_recieved','adminlte::adminlte.verify_request_another','adminlte::adminlte.confirm_password_message',
'adminlte::adminlte.remember_me_hint','adminlte::iframe.btn_close','adminlte::iframe.btn_close_active','adminlte::iframe.btn_close_all','adminlte::iframe.btn_close_all_other',
'adminlte::iframe.tab_empty','adminlte::iframe.tab_home','adminlte::iframe.tab_loading','adminlte::menu.main_navigation','adminlte::menu.blog',
'adminlte::menu.pages','adminlte::menu.account_settings','adminlte::menu.profile','adminlte::menu.change_password','adminlte::menu.multilevel',
'adminlte::menu.level_one','adminlte::menu.level_two','adminlte::menu.level_three','adminlte::menu.labels','adminlte::menu.important',
'adminlte::menu.warning','adminlte::menu.information',);
